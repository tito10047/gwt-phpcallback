...
class TestObject extends GwtRpcObject{
    ...
    protected $OBJECTS_VARS_METADATA=array("String[]","int[]","double[]","char[]","long[]","byte[]","short[]","boolean[]","TestObject[]","TestObject2[]","String");
    ...
    public $object2 = array(null,new TestObject2());        /*com.mostka.phprpclibtest.client.TestObject2[]*/
